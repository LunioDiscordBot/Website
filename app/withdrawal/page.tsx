          ...
          },
          {
            ...
            body: (
              <>
                ...
                . Bitte gib genügend Informationen an, um deinen Kauf zuzuordnen, etwa Discord-User-ID, betroffene Guild, Kaufdatum und das betroffene Premium-Produkt oder Abonnement.
              </>
            ),
          },
          {
            ...
            body:
              'Du kannst folgende Formulierung verwenden: "Hiermit widerrufe ich meinen Vertrag über den Kauf der folgenden digitalen Leistung: [Premium-Produkt beschreiben], bestellt am [Datum], Discord-Konto: [Nutzer- oder Guild-Angabe], Name: [dein Name], Datum: [heutiges Datum]."',
          },
          {
            title: "6. Kontakt",
            body: (
      ...
      : [
          {
            ...
            body:
              "If you are a consumer and purchase premium digital services or digital content from Lunio, you may have a statutory right to withdraw from the contract within 14 days, subject to the limitations and exceptions provided by applicable law.",
          },
          {
            title: "2. Immediate access to premium services",
            body:
              "Lunio premium is intended to be activated immediately after purchase or entitlement confirmation. If you expressly request immediate access during checkout or activation, you may lose your right of withdrawal once the digital service begins, to the extent permitted by applicable law.",
          },
          {
          ...
          },
          {
            ...
            body: (
              <>
                ...
                . Please include enough information to identify your purchase, such as the Discord user ID,
                relevant guild, purchase date, and the premium product or subscription involved.
              </>
            ),
          },
          {
            ...
            body:
              'You may use the following wording: "I hereby withdraw from my contract for the purchase of the following digital service: [describe premium product], ordered on [date], Discord account: [user or guild identification], name: [your name], date: [today\'s date]."',
          },
          {
            title: "6. Contact",
            body: (
          ...
          <div className="grid gap-8 xl:grid-cols-[minmax(0,320px)_minmax(0,1fr)] xl:items-start">
            <div className="xl:sticky xl:top-24">
              ...
              <p className="section-copy mt-5 max-w-sm">
                {messages.legal.withdrawalIntro}
              </p>
